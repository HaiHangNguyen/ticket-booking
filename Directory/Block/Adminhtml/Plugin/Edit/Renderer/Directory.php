 ...
 */
namespace Ticket\Directory\Block\Adminhtml\Plugin\Edit\Renderer;
...
/**
 * Class Directory
 * @package Ticket\Directory\Block\Adminhtml\Plugin\Edit\Renderer
 */
class Directory extends Template implements RendererInterface
{
     ...
     * {@inheritdoc}
     */
    protected $_template = 'Ticket_Directory::order/address/directory.phtml';
