...
namespace Ticket\Directory\Block\Checkout;
 ...
 * @package Ticket\Directory\Block\Checkout
 */
            ...
            if (strpos($elementName, '-form') !== false) {
                ...
                $formFields = array_replace_recursive(
                    ...
                    [
                        ...
                        'city_id' => [
                            'component' => 'Ticket_Directory/js/form/element/city',
                            'label' => __('City'),
                            'config' => [
                        ...
                        'district_id' => [
                            'component' => 'Ticket_Directory/js/form/element/district',
                            'label' => __('District'),
                            'config' => [
                                'template' => 'ui/form/field',
                                'elementTmpl' => 'ui/form/element/select',
                        ...
                        'ward_id' => [
                            'component' => 'Ticket_Directory/js/form/element/ward',
                            'label' => __('Ward'),
                            'config' => [
                                'template' => 'ui/form/field',
                                'elementTmpl' => 'ui/form/element/select',
